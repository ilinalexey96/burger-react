export const element = {
  ...
  export const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzODI1OGU2OWI1MThhMDAxYmI4ODBiMyIsImlhdCI6MTY2OTc0MDIyOSwiZXhwIjoxNjY5NzQxNDI5fQ.fe8_m9IesAkeCXWncfFMuAEKRwCNA83iSy_Nq4ddDNQ"
  ...
  export const constructorElement = '[class^=constructor-element]';
